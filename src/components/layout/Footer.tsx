...
const footerLinks = {
  solutions: [
    ...
    { name: "Occupancy Detection", href: "/monitoring/occupancy" },
    { name: "Smoke Detection", href: "/monitoring/smoke" },
    { name: "Environment Monitoring", href: "/monitoring/environment" },
    { name: "The Device", href: "/monitoring" },
  ],
  company: [
  ...
  resources: [
    { name: "Blog", href: "/blog" },
    { name: "Savings Calculator", href: "/resources/savings-calculator" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.linkedin.com/company/roomonitorsl/"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/@roomonitor"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="YouTube"
              ...
              <a
                href="https://www.instagram.com/roomonitor/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors"
              ...
              <a
                href="https://www.facebook.com/roomonitor"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="Facebook"
