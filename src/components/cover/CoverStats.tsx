...
const statConfigs = [
  { target: 268414, suffix: "", delay: 0 },
  { target: 97, suffix: "%", delay: 100 },
  { target: 4, suffix: " min", prefix: "<", delay: 200 },
  { target: 9580, suffix: "", delay: 300 },
  { target: 8, suffix: "", delay: 400 },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
          {statConfigs.map((stat, i) => (
            ...
            >
              ...
              <div className="text-sm text-background/60 mt-1">{labels?.[i]?.label}</div>
            </div>
          ))}
        </div>
      </div>
