        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection delay={200}>
            <div className="relative">
              ...
              <OptimizedImage src={image} alt={imageAlt} className="relative w-full rounded-2xl shadow-2xl object-cover" containerClassName="relative w-full rounded-2xl shadow-2xl overflow-hidden aspect-[4/3]" priority />
            </div>
          </AnimatedSection>
        </div>
      </div>
