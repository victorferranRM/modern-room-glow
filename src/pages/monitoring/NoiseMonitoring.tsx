  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            <p className="text-sm font-medium text-primary uppercase tracking-wider mb-4">{t('monitoringNoise.featuresEyebrow')}</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-6">{t('monitoringNoise.featuresTitle')}</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">{t('monitoringNoise.featuresSubtitle')}</p>
          </AnimatedSection>
      ...
      <section className="py-20 lg:py-28 bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            <p className="text-sm font-medium text-primary uppercase tracking-wider mb-4">{t('monitoringNoise.howItWorksEyebrow')}</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-6">{t('monitoringNoise.howItWorksTitle')}</h2>
          </AnimatedSection>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection delay={200}>
              <div className="relative group">
                ...
                <img src={managerDevices} alt={t('monitoringNoise.managerEyebrow')} className="relative w-full rounded-2xl shadow-lg border border-border/50" />
              </div>
            </AnimatedSection>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-primary/5 via-background to-secondary/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-6">{t('monitoringNoise.ctaTitle')}</h2>
            <p className="text-lg text-muted-foreground mb-8">{t('monitoringNoise.ctaDescription')}</p>
