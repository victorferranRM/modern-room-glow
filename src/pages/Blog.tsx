            ...
            <AnimatedSection animation="fade-up" delay={0.1}>
              ...
              <div className="grid md:grid-cols-2 gap-0">
                  <LocalizedLink to={`/blog/${featuredPost.slug}`} className="block relative">
                    ...
                    <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-foreground/70 backdrop-blur-sm text-background text-sm font-medium px-3 py-1.5 rounded-full">
