...
const mapCities = [
  { name: "Barcelona", x: 52, y: 168, isHQ: true },
  { name: "Madrid", x: 35, y: 172 },
  { name: "Valencia", x: 48, y: 178 },
  { name: "Málaga", x: 38, y: 195 },
  { name: "Seville", x: 28, y: 188 },
  { name: "Granada", x: 38, y: 190 },
  { name: "Lisbon", x: 18, y: 175 },
  { name: "Paris", x: 62, y: 122 },
  { name: "Milan", x: 95, y: 138 },
];
